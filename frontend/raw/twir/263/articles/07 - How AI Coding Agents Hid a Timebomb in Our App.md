...
Summary:
A postmortem on a production incident where an AI coding agent removed a critical comment and prop, leading to infinite recursion in a React component tree. The new <Activity> component in React 19.2 masked the bug by rendering hidden UI in low-priority mode, delaying crashes and complicating debugging. The author reflects on the importance of tests over comments, especially in AI-augmented codebases.

Key takeaways:
- AI agents can inadvertently remove critical safety constraints if only documented in comments.
- React 19.2’s <Activity> component can mask latent bugs by deferring their impact.
- Structural invariants should be enforced via tests, not just comments.
- Debugging hidden infinite recursion is challenging when UI is rendered in background.
...
![Outlyne Design UI Screenshot](https://www.acusti.ca/media/outlyne-design-ui.avif)
...
![Outlyne Footer Sidebar UI Screenshot](https://www.acusti.ca/media/outlyne-footer-sidebar.avif)
...
![Outlyne GitHub Commit Screenshot](https://www.acusti.ca/media/outlyne-footer-github-commit.png)
...
![Outlyne Footer Editor Redesign GitHub Commit Screenshot](https://www.acusti.ca/media/outlyne-footer-github-commit-2.png)
...
![Outlyne Cookie Settings GitHub Commit Screenshot](https://www.acusti.ca/media/outlyne-footer-github-commit-3.png)
