...
item_type: item
date: 2025-10-29
source: https://tanstack.com/blog/directives-and-the-platform-boundary
tags:
  - "directives"
  - "EAS"
status: auto
...
# Item 2: Directives and the Platform Boundary

Source: [https://tanstack.com/blog/directives-and-the-platform-boundary](https://tanstack.com/blog/directives-and-the-platform-boundary)

Summary:
Tanner Linsley examines the rise of framework-specific directives like "use client" and "use server" in the JavaScript ecosystem. He argues that while these directives provide ergonomic benefits, they blur the line between language features and framework conventions, leading to confusion, portability issues, and increased tooling complexity. Linsley suggests that explicit APIs with imports offer clearer provenance, better tooling support, and easier migration compared to directives masquerading as language features. He cautions against adopting shared syntax without shared standards, drawing parallels to past issues with decorators in TypeScript.

Key takeaways:
- Framework directives (e.g., "use client") are not standardized JS features and can cause confusion.
- Directives lack provenance, versioning, and composability compared to explicit APIs.
- Tooling and portability suffer when directives look like platform features but are framework-specific.
- Shared syntax without a shared spec leads to fragmentation and migration pain.

Recommendation:
Read fully (for those designing libraries/frameworks or tooling)

Why it matters:
for those designing libraries/frameworks or tooling
...
![Header Image](/.netlify/images?url=%2Fblog-assets%2Fdirectives-and-the-platform-boundary%2Fheader.png&w=800&q=80)
