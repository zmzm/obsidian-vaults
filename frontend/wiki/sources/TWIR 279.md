...
- Radix-to-Base UI migration and accessibility articles were dropped as marketing-padded content from commercial sites.
...
- It reinforces that accessibility and UI migration content from commercial certificate/premium sites tends to be thin and marketing-wrapped.
...
- Articles 5 (certificates.dev a11y) and 6 (shadcnstudio.com Radix-to-Base UI migration) were removed as content marketing.
