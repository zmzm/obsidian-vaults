...
# Item 6: Kent C. Dodds - Migrating Remix v2 to React Router v7 with Cursor

Source: [https://kentcdodds.com/blog/how-i-used-cursor-to-migrate-frameworks](https://kentcdodds.com/blog/how-i-used-cursor-to-migrate-frameworks)

Summary:
Kent C. Dodds details his experience using the Cursor AI agent to automate dependency upgrades, including a major migration from Remix v2 to React Router v7. The process involved grouping upgrades by difficulty, leveraging test coverage, and using AI to plan and execute complex changes like routing conventions and file structure updates. The article highlights both the capabilities and limitations of AI-assisted migrations in large React codebases.

Key takeaways:
- AI agents like Cursor can automate much of the upgrade process, especially with good tests and documentation.
- Major framework migrations still require human oversight, especially for routing and project structure.
- Incremental upgrades (using "future flags") help reduce migration risk.
- AI is effective for repetitive or well-scoped changes but may struggle with nuanced project conventions.
